...
//                .antMatchers(HttpMethod.GET,"/api/customers/{name}").permitAll()
...
//                .antMatchers(HttpMethod.GET,"/api/product-field/names/{name}").permitAll()
...
//                .antMatchers(HttpMethod.GET,"/api/paper-market-rates/paper-stocks/{stock}").permitAll()
...
//                .antMatchers(HttpMethod.GET,"/api/paper-size/labels/{label}").permitAll()
...
//                .antMatchers(HttpMethod.GET,"/api/press-machine/names/{name}").permitAll()
...
//                .antMatchers(HttpMethod.GET,"/api/uping/product-sizes/{size}").permitAll()
...
//                .antMatchers(HttpMethod.GET,"/api/vendor/names/{name}").permitAll()
...
//                .antMatchers(HttpMethod.GET,"/api/product-process/names/{name}").permitAll()
...
//                .antMatchers(HttpMethod.GET,"/api/product-definition/titles/{title}").permitAll()
...
//                .antMatchers(HttpMethod.DELETE,"/api/product-definition/{id}/{pdfId}/product-definition-field/selected-value").permitAll()
...
//                .antMatchers(HttpMethod.GET,"/api/setting/keys/{key}").permitAll()
...
//                .antMatchers(HttpMethod.GET,"/api/order/products/{product}").permitAll()
